...
#define DHTPIN 4 // Pino GPIO15 do ESP32 para o DHT22
#define DHTTYPE DHT22 // Tipo de sensor DHT (DHT22)
DHT dht(DHTPIN, DHTTYPE);
 
#define POT_PIN 35 // Pino GPIO34 do ESP32 para o Potenciômetro
 
// Credenciais
const char* ssid = "FIAP-IOT"; // Rede Wi-Fi
const char* password = "F!@p25.IOT"; // Senha da rede Wi-Fi
const char* apiKey = "Z0LROYDWHFQOSKRG"; // Write API Key
